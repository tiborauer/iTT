function iTT = tbx_cfg_iTT
% automatic configuration of the iTT toolbox for SPM12
...
%--------------------------------------------------------------------------
cfg = IniFile(fullfile(spm('dir'),'toolbox','iTT','config.ini'));
if cfg.config.check_getSPM
